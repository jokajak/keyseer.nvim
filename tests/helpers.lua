...
-- @usage global_equality(child, "_G.KeyfinderLoaded", true)
...
-- @usage global_type_equality(child, "_G.KeyfinderLoaded", "boolean")
...
Helpers.expect.config_equality = MiniTest.new_expectation(
    ...
    function(child, field, value)
        return Helpers.expect.global_equality(child, "_G.Keyfinder.config." .. field, value)
    end,
    errorMessage
)
...
Helpers.expect.config_type_equality = MiniTest.new_expectation(
    ...
    function(child, field, value)
        return Helpers.expect.global_equality(
            child,
            "type(_G.Keyfinder.config." .. field .. ")",
            value
        )
    end,
    errorMessage
...
Helpers.expect.state_equality = MiniTest.new_expectation(
    "state matches",
    function(child, field, value)
        return Helpers.expect.global_equality(child, "_G.Keyfinder.enabled." .. field, value)
    end,
    errorMessage
)
