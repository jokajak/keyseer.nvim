...
describe("qwerty_layout_test", function()
  it('renders_qwerty', function()
    assert.combinators.match(qwerty_layout, layouts.render(layouts.layouts["qwerty"]))
  end)
end)
...
describe("dvorak_layout_test", function()
  it('renders_dvorak', function()
    assert.combinators.match(dvorak_layout, layouts.render(layouts.layouts["dvorak"]))
  end)
end)
